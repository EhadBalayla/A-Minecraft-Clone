...
NoiseGeneratorPerlin2::NoiseGeneratorPerlin2() : NoiseGeneratorPerlin2(Random()) {

}

NoiseGeneratorPerlin2::NoiseGeneratorPerlin2(Random var1) {
...
double NoiseGeneratorPerlin2::generateNoise(double var1, double var3) {
	return this->generateNoise(var1, var3, 0.0);
}

double NoiseGeneratorPerlin2::generateNoiseD(double var1, double var3, double var5) {
	return this->generateNoise(var1, var3, var5);
}


double NoiseGeneratorPerlin2::generateNoise(double var1, double var3, double var5) {
	...
	return lerp(var20, lerp(var18, lerp(var16, grad(this->permutations[var24], var7, var9, var11), grad(this->permutations[var2], var7 - 1.0, var9, var11)), lerp(var16, grad(this->permutations[var4], var7, var9 - 1.0, var11), grad(this->permutations[var22], var7 - 1.0, var9 - 1.0, var11))), lerp(var18, lerp(var16, grad(this->permutations[var24 + 1], var7, var9, var11 - 1.0), grad(this->permutations[var2 + 1], var7 - 1.0, var9, var11 - 1.0)), lerp(var16, grad(this->permutations[var4 + 1], var7, var9 - 1.0, var11 - 1.0), grad(this->permutations[var22 + 1], var7 - 1.0, var9 - 1.0, var11 - 1.0))));
}

double NoiseGeneratorPerlin2::generateNoise(double var0) {
	return var0 * var0 * var0 * (var0 * (var0 * 6.0 - 15.0) + 10.0);
}

double NoiseGeneratorPerlin2::lerp(double var0, double var2, double var4) {
	return var2 + var0 * (var4 - var2);
}

double NoiseGeneratorPerlin2::grad(int var0, double var1, double var3, double var5) {
	var0 &= 15;
